              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium text-muted-foreground">Uploads</th>
                  ...
                  {filteredFarmers.map((farmer) => (
                    <tr key={farmer._id} className="border-b hover:bg-muted/50">
                      ...
                      <td className="py-3 px-4 text-sm font-bold text-primary">
                        {products.filter(p => p.farmerId === (farmer.userId || farmer._id.toString().replace('no-profile-', ''))).length}
                      </td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
              ...
              <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => setActiveView("uploads")}>
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-muted-foreground">Farmer Uploads</p>
